const ColdMenuDB = {
  items: [
    ...
    {name: '"Цезарь" с креветками', price : 790, weight: 277, id: 7, img: "../../images/HotDishes/1.jpg",
    ...
    {name: '"Цезарь" с цыплёнком', price : 690, weight: 282, id: 8, img: "../../images/HotDishes/1.jpg",
      description: 'Листья салата ромейн, заправленный соусом цезарь, сыром пармезан, каперсами и анчоусами. Гарнир -сухарики из подпеченной чиабаты' +
        'и филе цыплёнка'
    },
  ]
